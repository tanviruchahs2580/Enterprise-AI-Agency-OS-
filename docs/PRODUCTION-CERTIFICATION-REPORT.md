...
Generated: 2026-08-25T04:23:59.521Z
Verdict: **NOT CERTIFIED - BLOCKED (see items)**

| Category | Gate | Status | Evidence |
|---|---|---|---|
| Application | unit+integration+e2e suite | PASS | 62/62 passed |
...
| Database | postgres live drill | BLOCKED | requires portable PG on :54329 (DEPLOYMENT-RUNBOOK local-pg section) |
...
| Observability | /metrics + /ready live | PASS | 40 lines scraped |
